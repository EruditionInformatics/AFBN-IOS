//
//  InvoicesTrackingViewController.swift
//  AFBN
//
...
class InvoicesTrackingCollectionViewCell:UICollectionViewCell{
...
class InvoicesTrackingViewController: UIViewController {
    
    @IBOutlet weak var invoicesTrackingCollectionVw:UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        icon_titleArray = ["Invoices","Invoices Statistics","Received\nInvoices","Received Invoices\nStatistics"]
    }
...
extension InvoicesTrackingViewController: UICollectionViewDelegate , UICollectionViewDataSource ,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let collectionViewCell:InvoicesTrackingCollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: "InvoicesTrackingCollectionViewCell", for: indexPath) as! InvoicesTrackingCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath){
        ...
        if(indexPath.item == 0){
            ...
            let invoicesController = storyBoard.instantiateViewController(withIdentifier: "InvoicesViewController") as! InvoicesViewController
            //self.present(singInController, animated: true, completion: nil)
            self.navigationController?.pushViewController(invoicesController, animated: true)
